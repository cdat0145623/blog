        ...
        <div className={cx('topBar')}>
            ...
            <div className={cx('topBar-center')}>
                <ul className={cx('topBar-list')}>
                    <li className={cx('topBar-item')}>HOME</li>
                    <li className={cx('topBar-item')}>ABOUT</li>
                    <li className={cx('topBar-item')}>CONTACT</li>
                    <li className={cx('topBar-item')}>WRITE</li>
                    <li className={cx('topBar-item')}>LOGOUT</li>
                </ul>
            </div>
